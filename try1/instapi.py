...
def main(debug,settings_file_path,username,password):

    logging.basicConfig()
    logger = logging.getLogger('instagram_private_api - session login')
    ...
    try:
        ...
        if not os.path.isfile(settings_file):
            ...
            logger.warn('Unable to find file: {0!s}'.format(settings_file))
...
if __name__ == '__main__':
    ...
    api = main(args.debug,args.settings_file_path,args.username,args.password)
